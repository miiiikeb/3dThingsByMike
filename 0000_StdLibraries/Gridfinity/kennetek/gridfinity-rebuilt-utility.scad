...
//2025-08-10(01) Start edit
//Added support for style_hole == 4: screw hole only
module block_base_hole(style_hole, o=0) {
    ...
    union() {
        if (style_hole==1||style_hole==2||style_hole==3){
            difference() {
        ...
        if (style_hole==2||style_hole==3||style_hole==4)
        cylinder(h = 2*h_base-o, r = r1, center=true);
    }
}
//2025-08-10(01) End edit
