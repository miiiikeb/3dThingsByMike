...
module pos(){
    ...
    cuts = 400; //400; //lo-res = 100, hi-res = 400
    rotate_cuts = 360; //360; //lo-res = 30, hi-res = 360
    os_r = 0.5;
    ...
    rotate_extrude(convexity = 10, $fn = rotate_cuts) rotate([0,0,90]) offset(r=0.5){
        projection(){
            for(i=[0:cuts]){
                if(i<=oh_cuts){
